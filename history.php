            ...
            if ($resultHistory) {
                if ($resultHistory->num_rows > 0) {
                    ...
                    while ($rowHistory = $resultHistory->fetch_assoc()) {
                        ...
                        echo "<td><a href='hasil.php?vin=" . $rowHistory['vin'] . "&areaPart=" . $rowHistory['area/part'] . "&defect=" . $rowHistory['defect'] . "&ctg=" . $rowHistory['ctg'] . "&pic=" . $rowHistory['pic'] . "&model=" . $rowHistory['model'] . "&suffix=" . $rowHistory['suffix'] . "&analisis=" . urlencode($rowHistory['analisis']) . "'>Hasil Analisis</a></td>";
                        echo "</tr>";
                    }
                } else {
