...
<script>
    $(document).ready(function() {
        ...
        $('tbody').on('click', '.status-button', function() {
            ...
            var ctg = $(this).closest('tr').find('td:eq(4)').text();
            var pic = $(this).closest('tr').find('td:eq(5)').text();
            var model = $(this).closest('tr').find('td:eq(6)').data('model');
            var suffix = $(this).closest('tr').find('td:eq(7)').data('suffix');

            // Redirect ke halaman lain dengan parameter data
            window.location.href = 'halaman_baru.php?vin=' + vin + '&areaPart=' + areaPart + '&defect=' + defect + '&ctg=' + ctg + '&pic=' + pic + '&model=' + model + '&suffix=' + suffix + '&analisis=true';
            }
        });
...
<form method="post" action="">
        ...
        <label for="areaPart">AREA/PART:</label>
        <input type="text" name="areaPart" id="areaPart" required>
        
        <label for="defect">DEFECT:</label>
        <input type="text" name="defect" id="defect" required>

        <label for="ctg">CTG:</label>
        <input type="text" name="ctg" id="ctg" required>
        ...
        <button type="submit" name="addData">Tambahkan</button>
    </form>
    -->
                            ...
                            <div class="card-body" style= "background-color: #15253F">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">CTG</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($allData as $row) {
                                            ...
                                            <tr> 
                                                ...
                                                <td class="suffix-cell" data-suffix="<?= $row['suffix']; ?>">
                                                    <?= $row['suffix']; ?>
                                                    <span class="status-marker not-clicked"></span>
                                        ...
                                        if (isset($_POST['addData'])) {
                                            ...
                                            $sqlInsert = "INSERT INTO input_data (`vin`, `area/part`, `defect`, `ctg`, `pic`, `model`, `suffix`) VALUES ('$vin', '$areaPart', '$defect', '$ctg', '$pic', '$model', '$suffix')";
