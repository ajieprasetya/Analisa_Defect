        ...
        if ($resultHistory) {
            if ($resultHistory->num_rows > 0) {
                ...
                while ($rowHistory = $resultHistory->fetch_assoc()) {
                    ...
                    echo "<td><a href='hasil.php?vin=" . $rowHistory['vin'] . "&areaPart=" . $rowHistory['area/part'] . "&defect=" . $rowHistory['defect'] . "&pic=" . $rowHistory['pic'] . "&model=" . $rowHistory['model'] . "&analisis=" . urlencode($rowHistory['analisis']) . "'>Lihat Hasil Analisis</a></td>";
                    echo "</tr>";
                }
            } else {
